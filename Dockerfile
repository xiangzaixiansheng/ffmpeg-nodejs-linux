...
RUN tar zxf /etc/dAppCluster/node-v20.19.0-linux-x64.tar.gz -C /etc/dAppCluster/ && \
    mkdir -p /usr/local/nodejs && \
    mv /etc/dAppCluster/node-v20.19.0-linux-x64/* /usr/local/nodejs && \
    rm -rf /etc/dAppCluster/node-v20.19.0-linux-x64 /etc/dAppCluster/node-v20.19.0-linux-x64.tar.gz
